...
interface data{
   title:String, desc:String, pic:String, score:Number,
    city:{
      from:String,
      to:String
      },
  ...
  <div class="rounded-md p-8 bg-white shadow-md">
          <div class="grid grid-cols-6 gap-4 items-center">
            <div class="col-span-1 flex flex-col items-center">
              <div
                class="w-10 h-10 rounded-full bg-slate-100 shadow-md border"
              >
              </div>
              ...
              <svg
                ...
                width="80.659"
                height="27.135"
                viewBox="0 0 142.659 27.135"
              >
                <g id="rate" transform="translate(-1563.342 -895)">
                  <path
                    id="Path_316"
                    data-name="Path 316"
                    d="M15,0l3.368,10.365h10.9l-8.817,6.406,3.368,10.365L15,20.729,6.183,27.135,9.551,16.771.734,10.365h10.9Z"
                    transform="translate(1676.734 895)"
                    fill="#ffcb14"
                  />
                  <path
                    id="Path_315"
                    data-name="Path 315"
                    d="M15,0l3.368,10.365h10.9l-8.817,6.406,3.368,10.365L15,20.729,6.183,27.135,9.551,16.771.734,10.365h10.9Z"
                    transform="translate(1648.203 895)"
                    fill="#ffcb14"
                  />
                  <path
                    id="Path_314"
                    data-name="Path 314"
                    d="M15,0l3.368,10.365h10.9l-8.817,6.406,3.368,10.365L15,20.729,6.183,27.135,9.551,16.771.734,10.365h10.9Z"
                    transform="translate(1619.671 895)"
                    fill="#ffcb14"
                  />
                  <path
                    id="Path_313"
                    data-name="Path 313"
                    d="M15,0l3.368,10.365h10.9l-8.817,6.406,3.368,10.365L15,20.729,6.183,27.135,9.551,16.771.734,10.365h10.9Z"
                    transform="translate(1591.14 895)"
                    fill="#ffcb14"
                  />
                  <path
                    id="Path_312"
              ...
              <div class="text-xs text-primary flex flex-col gap-1 text-center">
            ...
            <div class="col-span-3">
              <div class="grid grid-cols-3">
                <div class="flex flex-col gap-1 items-center">
                  <h3 class="text-lg font-semibold">{{city?.from}}</h3>
                  <span class="text-sm">19:30</span>
                  <span class="text-xs">مهرآباد</span>
                  <span class="text-xs mt-2">نوع پرواز</span>
                  <span class="text-sm font-semibold">سیستمی</span>
                </div>
                ...
                <div class="flex flex-col gap-1 items-center">
                  ...
                  <span class="text-sm">19:30</span>
                  <span class="text-xs">مهرآباد</span>
                  <span class="text-xs mt-2">کلاس</span>
                  <span class="text-sm font-semibold">اکونومی</span>
                </div>
              </div>
            </div>
            <div class="col-span-2 flex items-center flex-col gap-2">
              <span class="text-pink-500 text-lg font-semibold"
                >12,000,000 تومان</span
              >
              <button
                class="bg-[#1976D2] text-sm font-semibold rounded-md shadow-md py-2 px-6 shadow-slate-300/30 text-white"
              >
                انتخاب بلیط
              </button>
              <span class="text-sm text-pink-500">6 صندلی خالی</span>
            </div>
          </div>
        </div>
</template>
